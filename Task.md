# Список завдань (Task.md) - Nova Poshta AI Bot v0.19.6
...
- [x] **Крок 4: Підтримка адресної доставки, вибір вулиць та природномовне редагування (v0.19.4 - v0.19.6)**
  ...
  - [x] Підтримка природномовного редагування будь-яких полів накладної (ПІБ, телефон, місто, адреса/відділення, опис, оцінка, наложка)
...
- [x] **Крок 5: Тестування та Документація**
  - [x] Написати модульні тести для адресної доставки та вибору вулиць `StreetSelectCallback` (36 passed)
