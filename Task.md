# Список завдань (Task.md) - Nova Poshta AI Bot v0.20.1
...
- [x] **Крок 6: Генерація та оптимізація штрих-кодів для накладних (v0.20.0 - v0.20.1)**
  ...
  - [x] Оптимізувати пропорції штрих-коду (`module_width=0.35`, `font_size=9`, `quiet_zone=6.5`) для 100% вміщення 14-значного номера ТТН без обрізання країв
  - [x] Написати юніт-тести для перевірки надсилання штрихкоду (40 passed)

- [x] **Крок 7: Тестування та Документація**
