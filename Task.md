# Список завдань (Task.md) - Nova Poshta AI Bot v0.10.1
...
- [x] **Крок 2: Інтеграція з Nova Poshta API**
  ...
  - [x] Додано автоматичний retry при отриманні `To many requests` від Nova Poshta API
...
- [x] **Крок 4: Telegram Bot Interface (aiogram 3)**
  - [x] Перевірка номера відділення/поштомату у всіх кандидатах однакових міст з паузами 0.25с
