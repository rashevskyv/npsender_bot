# Список завдань (Task.md) - Nova Poshta AI Bot v0.9.0
...
- [x] **Крок 3: Інтеграція з AI (OpenAI / Gemini / Local Web2API)**
  ...
  - [x] Налаштовано робастні Pydantic-валідатори для обробки `null` значень від AI моделей (`is_postomat`, `is_recipient_info`)
...
- [x] **Крок 4: Telegram Bot Interface (aiogram 3)**
  ...
  - [x] Реалізовано асинхронний дибаунсер (`USER_MESSAGE_BUFFERS`, `USER_DEBOUNCE_TASKS`) для буферизації миттєвих перепощених повідомлень
  - [x] Об'єднання багатокомпонентних та перепощених повідомлень у єдиний AI-запит
