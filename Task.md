# Список завдань (Task.md) - Nova Poshta AI Bot v0.19.7
...
- [x] **Крок 4: Підтримка адресної доставки, вибір вулиць, збереження стану сесії та природномовне редагування (v0.19.4 - v0.19.7)**
...
- [x] **Крок 5: Тестування та Документація**
  - [x] Написати модульні тести для збереження стану сесії та вибору вулиць (37 passed)
