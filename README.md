...
- **🗣️ Full Natural Language & Voice Waybill Editing**: Modify any part of a waybill draft at any time using plain text or voice messages (e.g., *"зміни прізвище на Петренко"*, *"новий телефон 097..."*, *"відправ у Львів"*, *"поміняй на відділення №5"*, *"вулиця Франка 10, а не провулок"*, *"опис планшет"*, *"оцінка 15000"*).
